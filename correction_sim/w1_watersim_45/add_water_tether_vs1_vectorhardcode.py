# Usage: python add_water_tether_vs1_vectorhardcode.py --systemXMLinFile w1_sys_noVS.xml --systemXMLoutFile w1_sys.xml --receptorPDBinFile w1_noVS.pdb --systemPDBoutFile w1.pdb --virtualsite "17 19 20"
# <ThreeParticleAverageSite p1="4113" p2="4115" p3="4116" w1="-2.3325082527557317" w2="5.665016505511463" w3="-2.3325082527557317"/>
...
def addVS1(virtualsite):
    ...
    r0_v = np.asarray(rcpt_positions[int(vs_indexes[0])]/unit.nanometer) 
    r1_v = np.asarray(rcpt_positions[int(vs_indexes[1])]/unit.nanometer) 
    r2_v = np.asarray(rcpt_positions[int(vs_indexes[2])]/unit.nanometer)
    print(r0_v, r1_v, r2_v)
    ...
    #w2 = -1*h
    #<ThreeParticleAverageSite p1="4113" p2="4115" p3="4116" w1="-2.3325082527557317" w2="5.665016505511463" w3="-2.3325082527557317"/>
    w0 = -2.3325082527557317
    w1 = 5.665016505511463
    w2 = -2.3325082527557317
