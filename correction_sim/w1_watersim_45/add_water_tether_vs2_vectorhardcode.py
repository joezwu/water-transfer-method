# Usage: python add_water_tether1_vs.py --systemXMLinFile --systemXMLoutFile --receptorPDBinFile --systemPDBoutFile --virtualsite --virtualsite2 
...
chaincomplex2 = pdbrcpt.topology.addChain("H")
...
def addVS1(virtualsite):
    ...
    #w1 = 1+2*h
    #w2 = -1*h
    w0 = -0.8760089800909506 
    w1 = 2.7520179601819015 
    w2 = -0.8760089800909506
...
def addVS2(virtualsite):
    ...
    #w1 = 1+2*h
    #w2 = -1*h
    w0 = -0.9069168848593657 
    w1 = 2.8138337697187312 
    w2 = -0.9069168848593657
    rv = (w0*r0_v + w1*r1_v + w2*r2_v) * unit.nanometer / unit.angstrom
    rv_vec3 = Vec3(rv[0], rv[1], rv[2]) * angstrom
