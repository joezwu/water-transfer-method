# Usage: python add_water_tether_vs1.py --systemXMLinFile btk-s8-s11_sys_noVS.xml --systemXMLoutFile btk-s8-s11_sys.xml --receptorPDBinFile btk-s8-s11_noVS.pdb --systemPDBoutFile btk-s8-s11.pdb --virtualsite "5404 5414 5405" --waterOindex "4849" 
...
parser.add_argument('--waterOindex',  required=True,  type=str, default=None,
        help='Adds index of water oxygen: "indexO"')
...
def addVS1(virtualsite):
    ...
    print("r1_v = %s, d = %s, rv_vec3 = %s \nw0 = %s \nw1 = %s \nw2 = %s" % (r1_v, d, rv_vec3, w0, w1, w2))
