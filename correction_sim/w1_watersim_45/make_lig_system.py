...
modeller = Modeller(lig1_ommtopology, lig1_positions)
...
if not rbfe:
    bbox = boundingBoxSizes(lig1_positions)
else:
...
system=forcefield.createSystem(modeller.topology, nonbondedMethod = PME, nonbondedCutoff = 0.9*nanometer, constraints=HBonds, rigidWater = True, removeCMMotion = False, hydrogenMass = hmass*amu)
